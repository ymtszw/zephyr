...
const STORAGE = "zephyr_v18"; // increment version to enforce old cache deletion
const APPSHELL = [
  "/",
  "/index.html",
  "/zephyr.js",
...
function isAppShellFile(url) {
  return (
    url === self.origin || APPSHELL.some(path => url === self.origin + path)
  );
}
